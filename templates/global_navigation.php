<nav class="GlobalNavigation">
    <ul>
        ...
        <li<?php if ($_SERVER['PHP_SELF'] === '/reports.php' && $_GET['action'] === 'lookup') : ?> class="active"<?php endif;?>><a href="/reports.php?action=lookup">Find stories</a></li>
        <li<?php if ($_SERVER['PHP_SELF'] === '/reports.php' && $_GET['action'] === 'new') : ?> class="active"<?php endif;?>><a href="/reports.php?action=new">Share your story</a></li>
